window.__require = function e(t, n, r) {
  ...
  ActorRenderer: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      initCountdown: function initCountdown() {
        ...
        progressTimer.setMidpoint(cc.v2(.5, .5));
  ...
  HotUpdate: [ function(require, module, exports) {
    ...
    var customManifestStr = JSON.stringify({
      packageUrl: "http://192.168.0.105/tutorial-hot-update/remote-assets/",
      remoteManifestUrl: "http://192.168.0.105/tutorial-hot-update/remote-assets/project.manifest",
      remoteVersionUrl: "http://192.168.0.105/tutorial-hot-update/remote-assets/version.manifest",
      version: "1.10",
      assets: {
        "src/cocos2d-jsb.js": {
          size: 3341465,
    ...
    cc.Class({
      ...
      updateCb: function updateCb(event) {
        ...
        if (needRestart) {
          ...
          cc.log("needRestart:" + JSON.stringify(newPaths));
          Array.prototype.unshift.apply(searchPaths, newPaths);
          cc.sys.localStorage.setItem("HotUpdateSearchPaths", JSON.stringify(searchPaths));
          jsb.fileUtils.setSearchPaths(searchPaths);
          cc.log("setSearchPaths33:" + JSON.stringify(searchPaths));
      ...
      onLoad: function onLoad() {
        cc.log("hot updatepanel onLoad");
        if (!cc.sys.isNative) {
          cc.log("hot updatepanel onLoad2");
          return;
        }
        cc.log("Storage path for getWritablePath : " + jsb.fileUtils.getWritablePath());
        ...
        cc.log("getStoragePath:", this._am.getStoragePath());
